...
namespace Technie.PhysicsCreator
{
	...
	public class Shortcuts
	{
		...
		{
			RigidColliderCreatorWindow rigidWindow;
			SkinnedColliderCreatorWindow skinnedWindow;

			if (IsRigidCreatorActive(out rigidWindow))
			{
				rigidWindow.AddHull();
				rigidWindow.Repaint();
			}
			else if (IsSkinnedCreatorActive(out skinnedWindow))
			{
				// TOOD!
			}
		}
		...
		{
			ICreatorWindow window;
			if (IsCreatorActive(out window))
			{
